...
class TestMain(unittest.TestCase):
    ...
    def test_total_result(self):
        ...
        self.assertAlmostEqual(22.3080687992392, df_t.output_of_heat_source_heating[0])
        self.assertAlmostEqual(2.74914120989784, df_t.output_of_heat_source_sensible_cooling[4798])
